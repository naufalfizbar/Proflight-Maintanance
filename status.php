...
<body class="bg-slate-100">
    ...
    <div class="container mx-auto p-4">
        <div class="container mx-auto px-4 py-8">
            <h2 class="text-2xl font-bold mb-4">Aircraft Status</h2>
          ...
          ?>
                <div class="bg-white rounded-lg shadow-md p-4">
                    ...
                    <p class="text-gray-700">Status: <?=$data['status_repair']=='1'?"Finish":"In Progress"?></p>
                    <p class="text-gray-700">Duration: <?=$data['start_time']?> - <?=$data['end_time']?></p>
                </div>
                <?php } ?>
                <!-- 
            <div class="bg-white rounded-lg shadow-md p-4">
                <h3 class="text-lg font-bold mb-2">Aircraft 4</h3>
                <p class="text-gray-700">Status: Completed</p>
                <p class="text-gray-700">Duration: 12-3-2023 13.45 - 13-3-2023 09.00</p>
            </div> -->
            </div>
        </div>
</body>
