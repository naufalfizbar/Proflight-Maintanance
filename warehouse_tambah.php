...
<body class="bg-gray-100">
    ...
    <div class="container mx-auto px-4 py-8">
                ...
                <form action="" method="post">
                    <div class="mb-4">
                        ...
                        <input
                            ...
                            name="id_barang" type="text" placeholder="Enter item ID">
                    </div>
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="flex items-center">
                            <input
                                ...
                                name="banyak" type="number" placeholder="Enter quantity">
                        </div>
                    </div>
        ...
        //   move_uploaded_file($source, $folder.$nama_file);
          $insert = mysqli_query($connect, "INSERT INTO `data_gudang`(`id_barang`, `nama_barang`, `banyak`) VALUES ('$id_barang','$nama_barang', '$banyak')");
